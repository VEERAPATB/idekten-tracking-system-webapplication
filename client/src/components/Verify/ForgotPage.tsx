          ...
          description={
            <div className="flex flex-col gap-[2rem]">
              <p className="text-sm text-center leading-relaxed">
                A verification email has been sent to your email <span className=" font-bold text-[#73408A]">idektep.test@gmail.com</span> Please check your email and click the link provided in the email to complete your account registration.
              </p>
