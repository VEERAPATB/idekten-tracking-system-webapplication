    ...
    <div>
      {(isStudent || isDashboard || isEditStudent) && (
        <a
          ...
          className={`flex items-center ${isDashboard ? "text-white" : ""} ${
            isStudent ? "text-[#D29F48]" : "text-white"
          } hover:text-[#D29F48]`}
        >
          <Image
            alt=""
            ...
            height={72}
            className={`${
              isStudent ? "" : "filter brightness-0 invert"
      ...
      {(isEmployee || isAssessment || isEditEmployee) && (
        <a
          ...
          className={`flex items-center ${isAssessment ? "text-white" : ""} ${
            isEmployee ? "text-[#D29F48]" : "text-white"
          } hover:text-[#D29F48]`}
        >
          <Image
            alt=""
