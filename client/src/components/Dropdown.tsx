...
const Dropdown = (props: {
  ...
  return (
    <div className=" flex flex-col gap-[1rem] ">
      <select defaultValue={props.default} onChange={props.onChange} name={`${props.label}`} className={`${props.style} outline-none border-[1px] border-b-[2px] border-b-[#73408A] py-[0.5rem] px-[0.5rem] rounded`}>
