...
const RegisterStudent = (props: PageProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axiosServer.post("/api/register/student", {
        ...userData,
  ...
  const fetchBranch = async () => {
    setLoading(true);
    try {
      const data = await axiosServer.get("/api/register/student");
  ...
  return (
    <>
      ...
      <div className=" absolute mt-[3rem] left-1/2 -translate-x-1/2 mb-[10rem]">
        {!successful ? (
          <form
            className=" rounded-[0.625rem] h-[42.25rem] w-[22rem] md:w-[42rem] bg-white shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)] mb-[3rem]"
                  ...
                  >
                    <div className="relative w-full information flex flex-col gap-[3rem]">
                      ...
                      <div>
                        ...
                        />
                        <p className=" text-sm text-[#D64F4F] mt-[0.5rem]">
                          * ถ้าไม่มีให้กรอก - หรือ ไม่มี
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            description={
              <div className="flex flex-col gap-[2rem]">
                <p className="text-sm text-center leading-relaxed">
                  ...
                  <span className=" font-bold text-[#73408A]">{userData.email}</span> Please
                  check your email and click the link provided in the email to
