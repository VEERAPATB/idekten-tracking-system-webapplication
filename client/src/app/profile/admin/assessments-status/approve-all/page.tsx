                ...
                function={[
                  {
                    ...
                    function: (id, classId) => {
                      setLoading(true);
                      router.push(
                        `/profile/admin/assessments-status/status?approve=all&id=${id}&class=${classId}&hp=${pathname}?p=${page}&s=${status}`
                      );
                    },
                  },
                  {
                    ...
                    function: (id, classId) => {
                      setLoading(true);
                      router.push(
                        `/profile/admin/assessments-status/approve-id?status=no&id=${id}&class=${classId}&hp=${pathname}?p=${page}&s=${status}`
                      );
                    },
                  },
                ]}
