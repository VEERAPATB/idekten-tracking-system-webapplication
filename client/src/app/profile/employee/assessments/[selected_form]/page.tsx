          ...
          <div className="mx-[1.5rem]">
            ...
            >
              ...
              <div className="relative feedback text-[#3D3C3C] md:w-[57rem] mx-auto bg-[#FFF] py-[1.5rem] px-[1rem] flex flex-col gap-[1rem] rounded-sm shadow-[10px_10px_10px_0px_rgba(0,0,0,0.25)]">
                <h3 className=" font-medium text-[#D64F4F] w-2/3 mb-[1px]">
                ...
                <div className=" flex flex-col gap-[0.5rem]">
                  ...
                  ></textarea>
                  <p className="text-sm font-medium text-[#D64F4F]">*โปรดกรอกข้อมูลเกิน 10 ตัวอักษร <br/>*ไม่สามารถวางข้อความที่คัดลอกมาได้</p>
                </div>
                <div className=" flex flex-col gap-[0.5rem]">
